...
class StartPanel extends JLayeredPane implements ActionListener{
    ...
    public StartPanel(ChangePanel c) {
      ...
      //位置・サイズの決定
      title.setBounds(625-150, 225-50, 300, 100);
...
public class Mancala extends JPanel implements MouseListener{
    ...
    public void end(Graphics g) {
        if(boxes[4] > boxes[0]){
            ...
            cp.ChangeLayer(new ResultPanel(cp)); i++;
